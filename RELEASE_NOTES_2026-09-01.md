...
Hinweis: Dieses Dokument hält den damaligen Launch-Stand fest. Seit 12.09.2026 ist eine datensparsame Zählung einfacher Seitenaufrufe ohne Einwilligungsdialog vorbereitet; der aktuelle Status steht in `ANALYTICS-MEASUREMENT.md` und `LIVE-STATUS.md`.
...
- Sell-through aus Nutzereingaben
- Datenqualitätsbewertung
- Evidenz-Sperre zu `DATEN PRÜFEN`
- DealScore 0–100
- mehrere Rechenszenarien
- Gegenargument-Modus
...
- Steuer-/ELSTER-Vorbereitung grün
- Marken-/Namens-Risikosteuerung für Beta grün
- Hostingentscheidung für den aktuellen Betrieb grün

## Externe Beobachtung – kein gelber Punkt

Bis zum Launch werden nur reale externe Ergebnisse beobachtet:

- organische Nutzung und Reichweite
- tatsächliche Social-Preview-Caches nach realen Posts
- Suchmaschinen-Indexierung

Diese Punkte sind nicht vorab erzwingbar und keine technischen Release-Blocker.
...
Steuerliche Übermittlung mit echten Betriebsdaten, Amazon-Partnerlinks, eBay nur nach bestätigter EPN-Freigabe, finale Marken-/Kollisionsprüfung vor größerer Markeninvestition und ein möglicher Custom-Domain-Cutover werden erst nach dem Gewerbe-Gate ausgeführt. Diese Schritte werden nicht als bereits erteilte externe Freigaben dargestellt.
