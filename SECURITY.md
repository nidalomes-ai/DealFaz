# MESIQO Security Policy

MESIQO soll sicher, datensparsam und transparent betrieben werden.
...
Nutze stattdessen die Kontaktmöglichkeit, die auf der jeweils aktuellen öffentlichen MESIQO-Seite im Impressum bzw. in den Datenschutzhinweisen angegeben ist.

Bitte beschreibe möglichst:

- betroffene MESIQO-Version oder URL
...
**Keine Sicherheitsgarantie:** Auch mit diesen Kontrollen können Fehler vorkommen. MESIQO wird deshalb schrittweise und mit möglichst geringer Datenspeicherung aufgebaut.
